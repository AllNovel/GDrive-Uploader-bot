...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5273971006:AAGvNtylRtniCzvuYZdPVulCOAb9wtnGwUc' # Get it from https://t.me/BotFather
    APP_ID = '19634918' # Get it from my.telegram.org/apps
    API_HASH = 'a5ccbcc74daa6b7bc77de5654a62822c' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://gjrspvdmzotzto:545556ebbb87c06d114abc3c5e8fe0ca83d3542b501d2a87eafb5d297574d076@ec2-3-225-79-57.compute-1.amazonaws.com:5432/dsuupvfs5can' # SQL Database URL / Heroku Postgres URL
